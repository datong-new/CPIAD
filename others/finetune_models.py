...
box_scale = 1.0
momentum = "momentum"
#save_image_dir = "../images_p{}x{}_scale{}_faster_box_sorted_momentum_0.3_emsemble".format(lines, lines, box_scale)
save_image_dir = "../images_p_finetune_{}_{}_{}".format("cascade", "retina", momentum)
...
#        optimizer.zero_grad()
       ...
       #     al, on = model_helper.attack_loss(patch_img)
        ...
        if object_nums==0:
            ...
            break
        """
        if object_nums==0 and attack_loss<5:
            success_attack=True
            break
